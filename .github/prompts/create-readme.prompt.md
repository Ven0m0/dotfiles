...
1. Do not include sections like "LICENSE", "CONTRIBUTING", "CHANGELOG", etc. There are dedicated files for those
   sections.
1. Use GFM (GitHub Flavored Markdown) for formatting, and GitHub admonition syntax
