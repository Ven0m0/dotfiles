...
alias bash='SHELL=bash bash' zsh='SHELL=zsh zsh' fish='SHELL=fish fish'
alias pacman='sudo pacman --noconfirm --needed' paru='paru --skipreview --noconfirm --needed --sudo "$SUDO"'
