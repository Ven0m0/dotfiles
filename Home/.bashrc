...
export ELECTRON_OZONE_PLATFORM_HINT=auto ELECTRON_TRASH=kioclient
...
if [[ ${XDG_SESSION_TYPE-} == wayland ]]; then
  export GDK_BACKEND=wayland QT_QPA_PLATFORM=wayland SDL_VIDEODRIVER=wayland CLUTTER_BACKEND=wayland GTK_USE_PORTAL=1 _JAVA_AWT_WM_NONREPARENTING=1
...
export CLAUDE_API_DISABLE_ANALYTICS=1 DISABLE_ANALYTICS=1
