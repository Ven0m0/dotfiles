...
if has wine || has proton; then
  ...
  export PROTON_DXVK_GPLASYNC=1 PROTON_HIDE_NVIDIA_GPU=0
  export PROTON_NVIDIA_LIBS_NO_32BIT=1 PROTON_NVIDIA_NVENC=1 PROTON_ENABLE_NGX_UPDATER=1 PROTON_ENABLE_NVAPI=1
  ...
  export PULSE_LATENCY_MSEC=60 WINE_FULLSCREEN_FSR=1 VKD3D_CONFIG=dxr,dxr11
  export WINE_NO_WM_DECORATION=1 WINE_PREFER_SDL_INPUT=1 SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS=0
