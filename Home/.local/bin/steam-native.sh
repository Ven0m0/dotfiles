...
export STEAM_RUNTIME=0 STEAM_RUNTIME_HEAVY=0 DBUS_FATAL_WARNINGS=0 PULSE_LATENCY_MSEC=60 SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS=0
...
exec /usr/lib/steam/steam -no-cef-sandbox -compat-force-slr off "$@"
