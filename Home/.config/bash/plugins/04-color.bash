...
#–– Colors
if has vivid; then
  export VIVID_THEME="molokai" LS_COLORS="$(vivid generate molokai &>/dev/null)"
...
export EZA_COLORS="$LS_COLORS" EZA_ICONS_AUTO=1 CLICOLOR=1 SYSTEMD_COLORS=1 PYTHON_COLORS=1
unset NOCOLOR
