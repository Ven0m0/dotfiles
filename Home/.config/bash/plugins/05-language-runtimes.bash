...
# --- Python
export PYTHONOPTIMIZE=2 PYTHONIOENCODING='UTF-8' PYTHON_JIT=1 PYTHONNODEBUGRANGES=1 PYTHON_COLORS=1 PYTHONSTARTUP="${HOME}/.pythonstartup" \
  PYTHONDONTWRITEBYTECODE=1 PYTHONUTF8=1 PYTHONSAFEPATH=1 \
