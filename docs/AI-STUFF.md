...
```text
create/update the [AGENTS.md](https://agents.md) and use the best practices, think about how to optimize it. Use `rg` for file discovery, ensure CLAUDE.md is a symlink to AGENTS.md . Run and apply "npx -y @yawlabs/ctxlint --depth 5 --mcp --strict --fix --yes", "npx -y agnix --fix ."
```
</details>
