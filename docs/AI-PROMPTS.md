...
```text
Documentation specialist: Analyze repo structure, languages, frameworks, conventions, workflows,
configs, patterns. Generate comprehensive AGENTS.md with: project overview + tech stack, repo
structure + key files (@prefix), dev workflows (setup/build/test/deploy), conventions
