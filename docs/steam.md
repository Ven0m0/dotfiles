...
- ARC Raiders: `PROTON_ENABLE_NVAPI=1 PROTON_DLSS_UPGRADE=1 PROTON_ENABLE_WAYLAND=1 PROTON_FSR4_UPGRADE=1 gamemoderun mangohud %command% -novid -dx12 -fullscreen`
