...
This repository is fully configured for [yadm](https://yadm.io) (Yet Another Dotfiles Manager) while maintaining a clean, hierarchical folder structure.
...
4. ✅ Set up system configs (requires sudo for etc/, usr/)
5. ✅ Process yadm alternate files
...
2. Test deployment: `yadm-sync pull` or `yadm bootstrap`
